...
export class AddBuildingImagesComponent implements OnInit {
    ...
    typeList: Array<{ key: string, value: string }> = [
        ...
        { key: "关于我们-栏目图片", value: "关于我们-栏目图片" },
        { key: "定制案例-栏目图片", value: "定制案例-栏目图片" },
        { key: "新闻资讯-栏目图片", value: "新闻资讯-栏目图片" },
        { key: "服务优势-栏目图片", value: "服务优势-栏目图片" },
        { key: "精英团队-栏目图片", value: "精英团队-栏目图片" },
        { key: "联系我们-栏目图片", value: "联系我们-栏目图片" },
